...
<div class="director-index container">
    ...
    <div class="mb-2">
        ...
        <?= HTML::a('Шаблон анкеты', '@web/Опрос_организаторов_(операторов)_питания.pdf', ['target' => '_blank', 'class' => 'btn btn-warning']); ?>
        <? echo Html::a('Шаблон анкеты с учетом заполненных школ', ['print-anket-pattern'], ['class' => 'btn btn-warning']); ?>
            ...
            [
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'visible' => $hasAccessFederalDistrict,
                    ],
                    [
                        'attribute' => 'region_id',
                        'label' => 'Регион',
