<div><b>7. Количество школ, в которых обучаются дети с заболеваниями, требующими индивидуальный подход в организации питания
    (заполняется по всем обсуживаемым школам, участвующим в анкетировании): </b></div>
